...
public class MongodbUtils {
    ...
    @Autowired
    public void setDatastore(MongoTemplate mongoTemplate) {
	 ...
	 * @return
	 */
	public static List<? extends Object> findCondition(Object obj, Criteria criteria, String collectionName) {
		Query query = Query.query(criteria);
		List<? extends Object> resultList = mongoTemplate.find(query, obj.getClass(), collectionName);
		return resultList;
	}
