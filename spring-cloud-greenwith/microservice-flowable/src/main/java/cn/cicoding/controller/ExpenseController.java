...
public class ExpenseController {
	 ...
	 */
	@ResponseBody
	@PostMapping(value = "ribbonProcessDiagram/{processId}")
	public void genRibbonProcessDiagram(HttpServletResponse httpServletResponse, @PathVariable String processId) throws Exception {
		ProcessInstance pi = runtimeService.createProcessInstanceQuery().processInstanceId(processId).singleResult();
		//流程走完的不显示图
		if (pi == null) {
			return;
