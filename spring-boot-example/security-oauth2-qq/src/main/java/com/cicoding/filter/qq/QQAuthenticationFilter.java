package com.cicoding.filter.qq;
...
public class QQAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
     ...
     * client_id 由腾讯提供
     */
    static final String clientId = "101543916";

    /**
     * client_secret 由腾讯提供
     */
    private final static String clientSecret = "3942bec725afb1f7e653b550d51ecf0e";

    /**
     * redirect_uri 腾讯回调地址
     */
    private final static String redirectUri = "http://www.cicoding.cn/login/qq";
